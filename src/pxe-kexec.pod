...
pxe-kexec [options] [I<tftp_server> [I<label>]]
...
If you already know which I<label> you want to boot, you can specify it as the
second argument. You can specify I<-> as I<tftp_server> if you want to use the
default behaviour but also boot a I<label> directly.
