...
no TFTP server specified, B<pxe-kexec> looks in the DHCP info file for the DHCP
...
Dont' display the PXE messages that are added in the PXE configuration with
the I<say> keyword.
...
E<lt>L<bwalle@suse.de>E<gt>.

=head1 BUGS

This program has no bugs. If you find a feature that should be removed,
please report to L<https://bugzilla.novell.com> and assign directly
to E<lt>L<bwalle@novell.com>E<gt> or via email at E<lt>L<bwalle@suse.de>E<gt>
